...
const RegisterScreen = (props) => {
  ...
  const handleSubmitButton = () => {
    ...
    fetch("http://brijesh.expresscab.in/wedding/sign-in-up.php?apicall=signup", {
      method: "POST",
      body: formBody,
      headers: {
        //Header Defination
  ...
  if (isRegistraionSuccess) {
    return (
      ...
      >
        ...
        />
        <Text style={styles.successTextStyle}>Registration Successfully.</Text>
        <TouchableOpacity
    ...
    <View style={{ flex: 1, backgroundColor: "#990000" }}>
      ...
      >
        <View style={{ alignItems: "center" }}>
          <Image
            source={require("../Image/slashscreen.png")}
            style={{
              width: "50%",
              height: 100,
              resizeMode: "contain",
