...
import { Image, StyleSheet, View, ScrollView, Text, Dimensions } from "react-native";
...
class SettingScreen extends Component {
  ...
  render() {
    ...
    global.image = `http://brijesh.expresscab.in/wedding/uploads/userimage/${pokeList.pick_url}`;
          ...
          <View style={styles.container}>
            <View>
              {!pokeList.pick_url == "" ? (
                <Image
                  style={styles.avatar}
                  source={{ uri: `http://brijesh.expresscab.in/wedding/uploads/userimage/${pokeList.pick_url}` }}
                />
              ) : (
            ...
            <View style={{ marginTop: 250 }}>
              {pokeList.status == 0 ? (
                ...
                <Text style={{ alignSelf: "center", fontSize: 15, color: "orange", marginTop: 10, fontWeight: "bold" }}>
                  Status: ACTIVE
                </Text>
              )}
              <Text style={{ alignSelf: "center", fontSize: 15, color: "#fff", marginTop: 10 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-start", marginTop: 20, width: width / 1.05 }}>
            ...
            <View style={styles.body}>
              <View style={{ padding: 15 }}>
                ...
                <View style={styles.userdetail}>
                  ...
                  <Text style={styles.textstyle1}>{pokeList.marital_Status}</Text>
                </View>
                <View style={styles.userdetail}>
                ...
                <View style={styles.userdetail}>
                  ...
                  <Text style={styles.textstyle1}>{pokeList.mother_Tonque}</Text>
                </View>
              </View>
            </View>
            <View style={{ flexDirection: "row", justifyContent: "flex-start" }}>
              <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 20, color: "#fff" }}>JOB PROFILE</Text>
            </View>
            <View style={styles.body}>
              <View style={{ padding: 15 }}>
                <View style={styles.userdetail}>
                  <Text style={styles.textstyle}>Work Status :</Text>
                  <Text style={styles.textstyle1}>{pokeList.current_Work_Status}</Text>
                </View>
                <View style={styles.userdetail}>
                  <Text style={styles.textstyle}>Salaried / Self Employee :</Text>
                  <Text style={styles.textstyle1}>{pokeList.salary_Status_Criteria}</Text>
                </View>
                <View style={styles.userdetail}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-start" }}>
              <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 20, color: "#fff" }}>EDUCATION</Text>
            </View>
            <View style={styles.body}>
              <View style={{ padding: 15 }}>
                <View style={styles.userdetail}>
                  <Text style={styles.textstyle}>Education :</Text>
                  <Text style={styles.textstyle1}>{pokeList.education_Qualification}</Text>
                </View>
              </View>
            </View>
          </View>
