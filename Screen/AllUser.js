...
class AllUser extends Component {
  ...
  async componentDidMount() {
    ...
    try {
      const pokemonApiCall = await fetch(`http://brijesh.expresscab.in/wedding/read/read_dashboard_data.php?uid=${ID}`);
            ...
            <View style={styles.container}>
              ...
              <View style={{ marginTop: 250 }}>
                {pokeList.status == 0 ? (
                  ...
                  <Text
                    style={{ alignSelf: "center", fontSize: 15, color: "orange", marginTop: 10, fontWeight: "bold" }}
                  >
                    Status: ACTIVE
                  </Text>
                )}
